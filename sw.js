const CACHE="roto-tanks-v1";const CORE=["./","./index.html","./products.html","./css/site.min.css","./js/app.min.js","./js/products.min.js","./data/products.min.js","./images/icons/icon.svg"];
